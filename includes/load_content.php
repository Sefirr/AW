...
<?php
	...
	while($content = $result->fetch_assoc()) {	
		...
		echo '<div style="background-color: #405656; margin-bottom:1%; padding:2%;">';		
		echo '<div id="titulo-serie">'.$content["titulo"].'</div>';
		echo '<div id="cartel"><img src="'.RAIZ_APP.$imagen.'"/></div>';
		echo '<div id="descripcion-basica">'.substr($content["sinopsis"],0,20).'</div>';
		echo '<div style="margin-left: 90%;"><a href="#">Leer más</a></div>';
		echo '</div>';
		//echo '<div id="detalle">';
