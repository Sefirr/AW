// JavaScript Document
	$(document).ready(function(){
		...
		$("#imgvaloracion").hide();
		$.get("../includes/procesaValoracionMercha.php?do=numVotos&nombre=" + nombre,process);
	});
		...
		function getRating(){
			...
			$.ajax({
				type: "GET",
				url: "../includes/procesaValoracionMercha.php",
				data: "do=getrate&nombre=" + nombre,
				cache: false,
				async: false,
		...
		function insertRating(){
			...
			$('#ratelinks li a').click(function(){
				$.ajax({
					type: "GET",
					url: "../includes/procesaValoracionMercha.php",
					data: "rating="+$(this).text()+"&do=rate&nombre=" + nombre,
					cache: false,
					async: false,
					success: function(result) {
